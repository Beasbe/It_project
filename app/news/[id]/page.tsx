      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-border">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="p-2 hover:bg-background rounded-full transition-colors">
              <svg className="w-5 h-5 text-copy-secondary" fill="currentColor" viewBox="0 0 24 24">
                <path d="M5.883 18.653c-3.152-.475-5.878-3.154-5.878-6.653 0-3.587 2.876-6.5 6.424-6.5 3.548 0 6.424 2.913 6.424 6.5 0 1.39-.425 2.683-1.155 3.755l-2.512-.419c.227-.73.35-1.504.35-2.336 0-2.485-1.991-4.5-4.448-4.5-2.456 0-4.447 2.015-4.447 4.5 0 2.485 1.991 4.5 4.447 4.5 1.104 0 2.12-.405 2.905-1.075l-1.074-1.773c-.546.44-1.206.687-1.831.687-1.656 0-3-1.344-3-3s1.344-3 3-3 3 1.344 3 3 c0 .275-.037.54-.107.795l2.507.418c.266-.93.413-1.915.413-2.913 0-4.142-3.32-7.5-7.424-7.5-4.105 0-7.424 3.358-7.424 7.5 0 4.142 3.32 7.5 7.424 7.5 1.78 0 3.435-.61 4.755-1.645l-1.249-2.062c-.956.706-2.125 1.107-3.376 1.107z" />
              </svg>
            </button>
            <button className="p-2 hover:bg-background rounded-full transition-colors">
              <svg className="w-5 h-5 text-copy-secondary" fill="currentColor" viewBox="0 0 24 24">
